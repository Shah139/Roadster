...
/**
 * Dashboard View - JavaFX equivalent of dashboard
 * This will contain the main dashboard with overview and navigation
 */
public class DashboardView extends HBox {
    ...
    private void initializeComponents() {
        ...
        cityDropdown.getItems().addAll("New York", "Los Angeles", "Chicago", "Houston", "Phoenix");
        cityDropdown.setValue("New York");
    ...
    private void setupCharts() {
        ...
        trafficChart.setPrefSize(300, 200);
    ...
    private VBox createDashboardContent() {
        ...
        // Traffic Chart Card with Crime Rate
        VBox trafficChartCard = createTrafficChartCard();
        GridPane.setConstraints(trafficChartCard, 0, 0, 1, 2);
        
        // Traffic Stats Card
        VBox trafficStatsCard = createTrafficStatsCard();
        GridPane.setConstraints(trafficStatsCard, 1, 0);
        
        // Accident Stats Card
        VBox accidentStatsCard = createAccidentStatsCard();
        GridPane.setConstraints(accidentStatsCard, 1, 1);
        
        // Live Alert Chart Card
        VBox liveAlertCard = createStatCard("Live Traffic Alert", trendChart);
        GridPane.setConstraints(liveAlertCard, 0, 2, 1, 1);
        
        // Incident Analysis Card
        VBox incidentAnalysisCard = createIncidentAnalysisCard();
        GridPane.setConstraints(incidentAnalysisCard, 1, 2);
        
        // Police Box Card
        VBox policeBoxCard = createNavigationCard("Police Box", "👮", "#e74c3c");
        GridPane.setConstraints(policeBoxCard, 0, 3);
        
        // Drivers List Card
        VBox driversCard = createNavigationCard("Drivers List", "🚗", "#27ae60");
        GridPane.setConstraints(driversCard, 1, 3);
        
        // Highlight Chart Card
        VBox highlightCard = createHighlightCard();
        GridPane.setConstraints(highlightCard, 0, 4, 2, 1);
        
        statsGrid.getChildren().addAll(
            trafficChartCard, trafficStatsCard, accidentStatsCard, 
            liveAlertCard, incidentAnalysisCard, policeBoxCard, 
            driversCard, highlightCard
        );
